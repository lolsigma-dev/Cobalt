...
#include "Modules/Crypt/Crypt.hpp"
#include "Modules/Console/Console.hpp"
#include "Modules/DebugEx/DebugEx.hpp"
#include "Modules/Drawing/Drawing.hpp"
...
inline void declare__Global(lua_State* L, const char* Name, lua_CFunction Function) {
	lua_pushcclosure(L, Function, nullptr, 0);
	lua_setglobal(L, Name);
}

inline void declare__Tablemember(lua_State* L, const char* Name, lua_CFunction Function) {
	lua_pushcclosure(L, Function, nullptr, 0);
